...
def train():
    ...
    state_dict = torch.load('resnet_ur5_model_physical_redo.pth')['model_state_dict']
    ...
    # Load data
    path = os.path.join(os.path.join(os.getcwd(), 'whip_ur5_dataset_redo'))
    holdout = 40
    ...
    torch.save({'model_state_dict': net50.state_dict(),
               ...
               }, 'resnet_ur5_model_physical_redo.pth')
    return trainLoss, valLoss

if __name__ == "__main__":
    trainLoss, valLoss = train()
    if not os.path.exists("./results_whip_ur5_physical"):
        os.makedirs('./results_whip_ur5_physical')
    save_dir = os.path.join(os.getcwd(), 'results_whip_ur5_physical')
