...
if __name__ == "__main__":
    ...
    if not os.path.exists("./results_cont"):
        os.makedirs('./results_cont')
    save_dir = os.path.join(os.getcwd(), 'results_cont')
    np.save(os.path.join(save_dir, 'trainloss_fwd_cont.npy'), train_loss_fwd)
    np.save(os.path.join(save_dir, 'valloss_fwd_cont.npy'), val_loss_fwd)
    EPOCHS = 2000
